...
const Book = () => {
    ...
    return (
        <div className="row">
            ...
            <div className="col-md-6 mt-5 rounded-3" style={{display: shippingData ? 'none' : 'block'}}>
                <div>
                    <div className="d-flex" >
                        <div className="mt-3 mb-3">
                            <img className="img-fluid" style={{ width: "100px", borderRadius: "50%" }} src={servicesFind?.imageURL} alt="" />
                        </div>
            ...
            <div className="col-md-6 mt-5" style={{display: shippingData ? 'block' : 'none'}}>
                <h1>Please Pay</h1>

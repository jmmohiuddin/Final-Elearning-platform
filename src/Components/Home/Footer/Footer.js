                    ...
                    <div className="col-11">
                        <div className="row ">
                            <div className="col-xl-8 col-md-4 col-sm-4 col-12 my-auto mx-auto a">
                                <h3 className="text-muted mb-md-0 mb-5 bold-text company-text">Pepper.</h3>
                            </div>
                        ...
                        <div className="row ">
                            <div className="col-xl-8 col-md-4 col-sm-4 col-auto my-md-0 mt-5 order-sm-1 order-3 align-self-end">
                                <p className="social socials text-muted mb-0 pb-0 bold-text"> <span className="mx-2"><i className="fab fa-facebook-f" aria-hidden="true"></i></span> <span className="mx-2"><i className="fab fa-linkedin-in" aria-hidden="true"></i></span> <span className="mx-2"><i className="fab fa-twitter" aria-hidden="true"></i></span> <span className="mx-2"><i className="fab fa-instagram" aria-hidden="true"></i></span> </p><small className="rights"><span>&#174;</span> Painter All Rights Reserved.</small>
                            </div>
